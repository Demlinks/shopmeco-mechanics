      ...
      <div className="md:w-7/12  md:flex md:justify-center lg:py-[28px] md:py-[18px]  md:px-[50px]">
        <div className=" md:w-[400px] lg:w-[500px] w-full  mt-8 px-5 ">
          <div className="font-semibold  whitespace-nowrap justify-end hidden md:flex md:pe-4">
            ...
            <Link to="/" className="span-color text-[14px] ">
              {" "}
              Log In
            </Link>
          </div>
          <div className="lg:my-[100px] my-[70px]">
            ...
            <div className=" flex flex-col gap-10 mt-8 ">
              <button
                className="shadow-xl  border-2 rounded-lg hover:border-[#5007E0] hover:bg-[#F5F3FF] lg:flex p-8 justify-center w-full items-center transition-colors duration-300 ease-in "
              ...
              >
                ...
                <div className="lg:w-[60%] text-center  px-3 lg:text-left mt-4 lg:mt-0  ">
                  ...
                  <p className="small-text font-semibold">
                    Personal account to manage your car and keep it in good
                    condition.
                  </p>
                </div>
              ...
              <Link to="/business-form" className="w-full">
                <button
                  className="shadow-xl  border-2 rounded-lg hover:border-[#5007E0] hover:bg-[#F5F3FF] lg:flex p-8 w-full justify-center items-center transition-colors duration-300 ease-in "
                ...
                >
                  ...
                  <div className="lg:w-[60%] text-center  px-3 lg:text-left mt-4 lg:mt-0 ">
                    ...
                    <p className="small-text font-semibold">
                      Business account for individual service providers and
                      companies.
                    </p>
                  </div>
                  <div className="lg:w-[20%] px-3 flex lg:justify-end justify-center  mt-4 lg:mt-0">
