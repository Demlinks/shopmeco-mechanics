      ...
      <div className="md:w-7/12  md:flex md:justify-center lg:py-[28px] md:py-[18px]  md:px-[50px]">
        <div className=" md:w-[400px] lg:w-[500px] w-full  mt-8 ">
          <div className="font-semibold  whitespace-nowrap justify-end hidden md:flex md:pe-4">
            ...
            <Link to="/getstarted" className="span-color text-[14px] ">
              Register
            </Link>
          </div>
          <div className="md:w-[400px]  w-full md:mt-10 md:px-4 mt-6">
            <h1 className="font-bold text-center md:text-left px-4 md:p-0">
              Login
            </h1>
            <p className=" text-center md:text-left small-text  flex md:block justify-center font-semibold mt-3 md:p-0 px-4 ">
              Login to your account and explore our services{" "}
              <br className="md:block hidden" /> and proficient technicians.
            </p>
            <form className=" mt-10  md:w-[350px] lg:w-[450px] mx-auto p-6 md:p-0 w-full">
              ...
              <div className="flex items-center relative">
                <input
                  ...
                  className=" mt-1 w-full span-color font-medium rounded-lg p-3 outline-color text-[14px] border-2 border-gray-300"
                  required
                />
                <button
                  onClick={toggleVisibility}
                  className="span-color show font-semibold cursor-pointer"
                >
              ...
              <div className="flex justify-between mt-2 font-semibold text-[14px]">
                <div className="flex justify-center items-center">
                  ...
                  <label htmlFor="remember" className="small-text">
                    Remember Me
                  </label>
                </div>
                <button className="span-color font-semibold text-[14px]">
                  Forgot Password?
                </button>
              </div>
